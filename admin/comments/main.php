...
switch ($op) {
    ...
    default:
        ...
        foreach ($module_array as $k => $v) {
            ...
            $comments_module .= '<option value="' . $k . '"' . $sel . '>' . $v . '</option>';
        }
        $xoopsTpl->assign('comments_module', $comments_module);
        ...
        foreach ($status_array as $k => $v) {
            ...
            $form .= '<option value="' . $k . '"' . $sel . '>' . $v . '</option>';
            $comments_status .= '<option value="' . $k . '"' . $sel . '>' . $v . '</option>';
        }
        $xoopsTpl->assign('comments_status', $comments_status);
        ...
        foreach ($limit_array as $k) {
            ...
            $comments_limit .= '<option value="' . $k . '"' . $sel . '>' . $k . '</option>';
        }
        $xoopsTpl->assign('comments_limit', $comments_limit);
