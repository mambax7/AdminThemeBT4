    ...
    default:
        ...
        if (isset($_REQUEST['complet_search'])) {
            ...
            $form          = '<form class="form-inline" action="admin.php?fct=users" method="post">
                    ' . _AM_SYSTEM_USERS_SEARCH_USER . '<input class="form-control col-2" type="text" name="user_uname" value="' . $myts->htmlSpecialChars($user_uname) . '" size="15">
                    <select class="browser-default custom-select ml-1" name="selgroups">
            ...
            $form .= '</select>&nbsp;
                ...
                <select class="browser-default custom-select" name="user_limit">
                ...
                <input class="btn btn-sm btn-primary" type="submit" value="' . _AM_SYSTEM_USERS_SEARCH . '" name="speed_search">&nbsp;
                <input class="btn btn-sm btn-primary" type="submit" value="' . _AM_SYSTEM_USERS_ADVANCED_SEARCH . '" name="complet_search"></form>
                ';
