...
class XoopsGuiCpadmin extends XoopsSystemGui
{
    ...
    public function header()
    {
        ...
        //$xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cpadmin/js/bootstrap.bundle.min.js');
        //$xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cpadmin/js/admin.js');
        ...
        if (empty($xoopsModule) || 'system' === $xoopsModule->getVar('dirname', 'n')) {
            ...
            foreach (array_keys($mod_options) as $item) {
                ...
                $mod_options[$item]['image'] = XOOPS_URL . '/modules/system/images/' . $mod_options[$item]['icon'];
                $mod_options[$item]['icon'] = $mod_options[$item]['icon'];
        ...
        foreach ($dirlist as $directory) {
            if (file_exists($admin_dir . '/' . $directory . '/xoops_version.php')) {
                ...
                if ($modversion['hasAdmin']) {
                    ...
                    $xoopsTpl->append_by_ref('adminmenu', $menu);
                    unset($menu);
                }
                unset($modversion);
            }
