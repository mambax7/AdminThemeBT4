        ...
        <table class="table table-bordered table-striped">
            ...
            <{foreach item=groups from=$groups}>
                <tr class="<{cycle values='odd, even'}> alignmiddle">
                    ...
                    <td class="txtleft">
                        <a href="admin.php?fct=groups&amp;op=groups_edit&amp;groups_id=<{$groups.groups_id}>" data-toggle="tooltip"
                    ...
                    <td class="xo-actions txtcenter">
                        ...
                        <{if $groups.delete|default:false}>
                            <a href="admin.php?fct=groups&amp;op=groups_delete&amp;groups_id=<{$groups.groups_id}>" data-toggle="tooltip"
