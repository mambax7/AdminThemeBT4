                ...
                <{foreach item=comments from=$comments}>
                    <tr class="<{cycle values='even,odd'}> alignmiddle">
                        ...
                        <td class="xo-actions txtcenter">
                            <a data-toggle="modal" data-target="#dialog<{$comments.comments_id}>">
...
<!--Pop-pup-->
<div class="modal fade" id="dialog<{$comments.comments_id}>" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><{$comments.comments_title}></h5>
